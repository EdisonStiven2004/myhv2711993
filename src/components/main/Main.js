...
function Main() {
  return (
    <div className='main'>        
        ...
        <h2>Formación académica SENA </h2>
        <div className="cvMain">          
            <p>tecnologo en anallisi y desarrollado de sofware .</p>
            <p>xxxx  </p>
            <p>.</p>
            <p>.</p>               
        </div>
        ...
        <div className="cvMain">
          <p><strong>Desarrolo de sofware .</strong>  Tecnologo  empleadas: HTML, CSS, JAVASCRIPT, NODEJS, REACT
